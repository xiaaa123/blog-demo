...
$(function() {
    ...
    console.log("%c Toretto %c", "background:#24272A; color:#ffffff", "", "https://zouwang.vip/");
    console.log("%c Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/Zou-Wang");
});
